...
CompactChordSymbols = {
        ...
        <c ees bes>^\markup\scale #'(0.4 . 0.6) \bold {m7} 
        <c e gis>^\markup\scale #'(0.4 . 0.6) \bold {+} 
        <c e gis bes>^\markup\scale #'(0.4 . 0.6) \bold {+7} 
        <c ees ges bes>^\markup\scale #'(0.5 . 0.7) \bold {ø} 
        <c ees ges beses>^\markup\scale #'(0.5 . 0.7) \bold {o7} 
        ...
        <c b a'>^\markup \bold \override #'(thickness . .5)  { \scale #'(.3 . .4) \triangle ##f \scale #'(0.4 . 0.6) 13 } 
                ...
                <c bes des'>^\markup \bold\scale #'(0.4 . 0.6)\bold {7 \flat 9} 

}

%\with-dimensions #'(-0.642 . 0.642)  #'(-0.642 . 0.642) 
