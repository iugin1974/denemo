            ...
            (begin 
                (if position
                   (begin
                            ...
                            (d-DirectivePut-chord-postfix tag (string-append shift position "#(make-dynamic-script #{ \\markup " markup " }#}) "))
