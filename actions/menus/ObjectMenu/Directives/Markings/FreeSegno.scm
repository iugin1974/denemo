;;;Segno  symbol attached to the next object, for example a barline. But shown between notes
(let ((tag "FreeSegno"))
...
#" choice "-of-line-invisible \\mark \\markup\\scale #'(1 . 1) { \\musicglyph #\"scripts.segno\" } ")) #t LG-Segno "" )))))
